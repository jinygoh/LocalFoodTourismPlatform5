    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        help_text="e.g. Mon-Sun: 10am - 10pm",
                        max_length=255,
                        null=True,
                    ),
                ),
                ...
                (
                    "dishes",
                    models.ManyToManyField(
                        blank=True, related_name="shops", to="core.dish"
                    ),
                ),
                (
                    "user",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "image",
                    models.ImageField(blank=True, null=True, upload_to="experiences/"),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                (
                    "dishes",
                    models.ManyToManyField(
                        blank=True, related_name="experiences", to="core.dish"
                    ),
                ),
                (
                    "shops",
                    models.ManyToManyField(
                        blank=True, related_name="participating_in", to="core.shop"
                    ),
                ),
                (
                    "vendor",
